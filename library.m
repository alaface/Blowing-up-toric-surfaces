...
// PseudoEff
// INPUT: a field, a list of rays, a positive integer m
// OUTPUT: the cone generated by classes of 
// generators of the Cox ring of Bl_eP up to 
// multiplicity m

PseudoEff := function(Q,ra,m)
 return Cone(GensUpTo(Q,ra,m));
end function;
...
PseudoNef := function(Q,ra,m)
 Eff := Cone(GensUpTo(Q,ra,m));
 M := IntMatBl(ra);
 return Dual(Eff*M);
end function;
